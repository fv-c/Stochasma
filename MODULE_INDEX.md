...
| `core/categorical.wl` | `categoricalForwardDiffuse` | `categoricalForwardDiffuse[state_, transitionKernel_List]` | Sample categorical states through a row-stochastic transition kernel using the current random stream. |
| `core/categorical.wl` | `categoricalForwardDiffuse` | `categoricalForwardDiffuse[state_, transitionKernel_List, uniformNoise_]` | Evaluate categorical forward diffusion with matching explicit uniform variates. |
