...
| `core/categorical.wl` | `categoricalSample` | `categoricalSample[predictor_, initialState_, schedule_Association, opts___]` | Run predicted-`x0` categorical reverse sampling with automatic, seeded, or explicit uniform variates. |
